...
def GetModelIndex(itemIndex):
    match itemIndex:
        ...
        case ItemDefinitionIndex.WEAPON_KNIFE_TACTICAL.value: return GetModelIndexByName("models/weapons/v_knife_tactical.mdl")
        ...
        case ItemDefinitionIndex.WEAPON_KNIFE_SURVIVAL_BOWIE.value: return GetModelIndexByName("models/weapons/v_knife_survival_bowie.mdl")
        case ItemDefinitionIndex.WEAPON_KNIFE_BUTTERFLY.value: return GetModelIndexByName("models/weapons/v_knife_butterfly.mdl")
        case ItemDefinitionIndex.WEAPON_KNIFE_PUSH.value: return GetModelIndexByName("models/weapons/v_knife_push.mdl")
        case ItemDefinitionIndex.WEAPON_KNIFE_URSUS.value: return GetModelIndexByName("models/weapons/v_knife_ursus.mdl")
        case ItemDefinitionIndex.WEAPON_KNIFE_GYPSY_JACKKNIFE.value: return GetModelIndexByName("models/weapons/v_knife_gypsy_jackknife.mdl")
        case ItemDefinitionIndex.WEAPON_KNIFE_STILETTO.value: return GetModelIndexByName("models/weapons/v_knife_stiletto.mdl")
        case ItemDefinitionIndex.WEAPON_KNIFE_WIDOWMAKER.value: return GetModelIndexByName("models/weapons/v_knife_widowmaker.mdl")
        case ItemDefinitionIndex.WEAPON_KNIFE_CSS.value: return GetModelIndexByName("models/weapons/v_knife_css.mdl")
        case ItemDefinitionIndex.WEAPON_KNIFE_CORD.value: return GetModelIndexByName("models/weapons/v_knife_cord.mdl")
        case ItemDefinitionIndex.WEAPON_KNIFE_CANIS.value: return GetModelIndexByName("models/weapons/v_knife_canis.mdl")
        case ItemDefinitionIndex.WEAPON_KNIFE_OUTDOOR.value: return GetModelIndexByName("models/weapons/v_knife_outdoor.mdl")
